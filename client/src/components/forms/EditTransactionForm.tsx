...
const editTransactionSchema = z.object({
  ...
  companyPercentage: z.number().min(0).max(100, { message: "Company percentage must be between 0 and 100" }).default(15),
...
const EditTransactionForm = ({ transaction, onClose }: EditTransactionFormProps) => {
  ...
  const form = useForm<z.infer<typeof editTransactionSchema>>({
    ...
    defaultValues: {
      ...
      companyPercentage: Math.round(initialCompanyPercentage) || 15,
